...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="LAB5_313551176_task2_pong.pt", help="Path to trained .pt model")
    parser.add_argument("--output-dir", type=str, default="./eval_videos_v2")
    parser.add_argument("--episodes", type=int, default=20)
    parser.add_argument("--video", type=int, default=True, help="Save evaluation videos")
    parser.add_argument("--seed", type=int, default=58836, help="Random seed for evaluation")
